...
const formulario = document.getElementById('formularioAvanzado');
 ...
 document
 .getElementById('apellidoCompleto')
 .addEventListener('input', function () {
 const valor = this.value.trim();
 const apellido = valor
 .split(' ')
...
// Validación de confirmación de contraseña
 ...
 const niveles = ['muy débil', 'débil', 'media', 'fuerte', 'muyfuerte'];
...
actualizarProgreso();
 ...
 document.getElementById('strengthBar').className = 'passwordstrength';
 }
document.addEventListener('DOMContentLoaded', () => {
 í
});
